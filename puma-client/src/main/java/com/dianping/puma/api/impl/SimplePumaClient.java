...
public class SimplePumaClient implements PumaClient {
   ...
   private String database;
	...
	private final HttpClient httpClient = HttpClients.custom()
	      .setDefaultRequestConfig(RequestConfig.custom().setConnectTimeout(60 * 1000)//
	...
	@Override
	public synchronized void subscribe(String database, List<String> tables, boolean dml, boolean ddl,
	      boolean transaction) {
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("clientName", clientName));
