...
public abstract class AbstractBaseTest {
	...
	private void initMonitor() {
		fetcherEventCountMonitor = new FetcherEventCountMonitor();
		fetcherEventCountMonitor.init();
		parserEventCountMonitor = new ParserEventCountMonitor();
		parserEventCountMonitor.init();
		storageEventCountMonitor = new StorageEventCountMonitor();
		storageEventCountMonitor.init();
		storageEventGroupMonitor = new StorageEventGroupMonitor();
		storageEventGroupMonitor.init();
	}
