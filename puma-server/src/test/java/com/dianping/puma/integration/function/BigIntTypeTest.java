...
public class BigIntTypeTest extends AbstractBaseTest {
			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testData.length; i++) {
					...
					Assert.assertEquals(
							testData[i][0],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_bigInt").getNewValue()))
									.longValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_bigInt").getOldValue());
					Assert.assertEquals(
							testData[i][1],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_bigInt").getNewValue()))
									.longValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_bigInt").getOldValue());
					Assert.assertEquals(
							testData[i][2],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_bigInt").getNewValue()))
									.longValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_bigInt").getOldValue());
					Assert.assertEquals(
							testData[i][3],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_bigInt").getNewValue()))
									.longValue());
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				long[][] testDataOld = { { 11, 11, 1, 1 }, { 11, -11, 9, 9 }, { 33, 77, 10, 10 }, { 33, -77, 99, 99 },
						{ 18866, 99987, 100, 100 }, { 18866, -99987, 33333, 33333 } };
				long[][] testDataNew = { { 11, -11, 1, 1 }, { 11, -11, 1, 1 }, { 33, -77, 10, 10 },
						{ 33, -77, 10, 10 }, { 18866, -99987, 100, 100 }, { 18866, -99987, 100, 100 } };
				...
				for (int i = 0; i < testDataOld.length; i++) {
					...
					Assert.assertEquals(
							testDataOld[i][0],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_bigInt").getOldValue()))
									.longValue());
					Assert.assertEquals(
							testDataNew[i][1],
							Long.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][1],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_bigInt").getOldValue()))
									.longValue());
					Assert.assertEquals(
							testDataNew[i][2],
							Long.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][2],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_bigInt").getOldValue()))
									.longValue());
					Assert.assertEquals(
							testDataNew[i][3],
							Long.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][3],
							Long.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_bigInt").getOldValue()))
									.longValue());
				}
			}
	...
	public void bigIntTypeDeleteTest() throws Exception {
		test(new TestLogic() {
			...
			@Override
			public void doLogic() throws Exception {
				long[][] testDataOld = { { 11, -11, 1, 1 }, { 11, -11, 1, 1 }, { 33, -77, 10, 10 },
						{ 33, -77, 10, 10 }, { 18866, -99987, 100, 100 }, { 18866, -99987, 100, 100 } };
