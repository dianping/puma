			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testData.length; i++) {
					...
					Assert.assertEquals(
							testData[i][0],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_decimal").getNewValue()))
									.doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_decimal").getOldValue());
					Assert.assertEquals(
							testData[i][1],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_decimal").getNewValue()))
									.doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_decimal").getOldValue());
					Assert.assertEquals(
							testData[i][2],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_decimal").getNewValue()))
									.doubleValue());
			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testDataOld.length; i++) {
					...
					Assert.assertEquals(
							testDataOld[i][0],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_decimal").getOldValue()))
									.doubleValue());
					Assert.assertEquals(
							testDataNew[i][1],
							Double.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][1],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_decimal").getOldValue()))
									.doubleValue());
					Assert.assertEquals(
							testDataNew[i][2],
							Double.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][2],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_decimal").getOldValue()))
									.doubleValue());
					Assert.assertEquals(
							testDataNew[i][3],
							Double.valueOf(
