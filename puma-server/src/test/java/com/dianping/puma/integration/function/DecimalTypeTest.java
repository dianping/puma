 ...
 *
 */
public class DecimalTypeTest extends AbstractBaseTest {
	
	private static final Logger LOG = LoggerFactory.getLogger(DecimalTypeTest.class);
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for(int i = 0; i < testData.length; i++){
					String insert_SQL = "INSERT INTO `" + SCHEMA_NAME +"`.`" + TABLE_NAME + "`(unsigned_decimal, signed_decimal, zerofill_decimal, unzerofill_decimal)VALUES(?, ?, ?, ?)";
				...
				for(int i = 0; i < testData.length; i++){
					...
					Assert.assertEquals(testData[i][0], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_decimal").getNewValue())).doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_decimal").getOldValue());
					Assert.assertEquals(testData[i][1], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_decimal").getNewValue())).doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_decimal").getOldValue());
					Assert.assertEquals(testData[i][2], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_decimal").getNewValue())).doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_decimal").getOldValue());
					Assert.assertEquals(testData[i][3], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_decimal").getNewValue())).doubleValue());
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for(int i = 0; i < testDataNew.length; i++){
					String update_SQL = "UPDATE `" + SCHEMA_NAME +"`.`" + TABLE_NAME + "` SET unsigned_decimal = ?, signed_decimal = ?, zerofill_decimal = ?, unzerofill_decimal = ? WHERE id = ?";
				...
				for(int i = 0; i < testDataOld.length; i++){
					...
					Assert.assertEquals(SCHEMA_NAME, rowChangedEvent.getDatabase());
					Assert.assertEquals(5, rowChangedEvent.getColumns().size());
					Assert.assertEquals(testDataNew[i][0], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_decimal").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][0], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_decimal").getOldValue())).doubleValue());
					Assert.assertEquals(testDataNew[i][1], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_decimal").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][1], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_decimal").getOldValue())).doubleValue());
					Assert.assertEquals(testDataNew[i][2], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_decimal").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][2], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_decimal").getOldValue())).doubleValue());
					Assert.assertEquals(testDataNew[i][3], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_decimal").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][3], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_decimal").getOldValue())).doubleValue());
				}
			}
