...
public class DoubleTypeTest extends AbstractBaseTest {

	private static final Logger LOG = LoggerFactory.getLogger(DoubleTypeTest.class);
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for(int i = 0; i < testData.length; i++){
					String insert_SQL = "INSERT INTO `" + SCHEMA_NAME +"`.`" + TABLE_NAME + "`(unsigned_double, signed_double, zerofill_double, unzerofill_double)VALUES(?, ?, ?, ?)";
				...
				for(int i = 0; i < testData.length; i++){
					...
					Assert.assertEquals(testData[i][0], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_double").getNewValue())).doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_double").getOldValue());
					Assert.assertEquals(testData[i][1], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_double").getNewValue())).doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_double").getOldValue());
					Assert.assertEquals(testData[i][2], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_double").getNewValue())).doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_double").getOldValue());
					Assert.assertEquals(testData[i][3], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_double").getNewValue())).doubleValue());
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for(int i = 0; i < testDataNew.length; i++){
					String update_SQL = "UPDATE `" + SCHEMA_NAME +"`.`" + TABLE_NAME + "` SET unsigned_double = ?, signed_double = ?, zerofill_double = ?, unzerofill_double = ? WHERE id = ?";
				...
				for(int i = 0; i < testDataOld.length; i++){
					...
					Assert.assertEquals(SCHEMA_NAME, rowChangedEvent.getDatabase());
					Assert.assertEquals(5, rowChangedEvent.getColumns().size());
					Assert.assertEquals(testDataNew[i][0], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_double").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][0], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_double").getOldValue())).doubleValue());
					Assert.assertEquals(testDataNew[i][1], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_double").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][1], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_double").getOldValue())).doubleValue());
					Assert.assertEquals(testDataNew[i][2], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_double").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][2], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_double").getOldValue())).doubleValue());
					Assert.assertEquals(testDataNew[i][3], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_double").getNewValue())).doubleValue());
					Assert.assertEquals(testDataOld[i][3], Double.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_double").getOldValue())).doubleValue());
				}
			}
