			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testData.length; i++) {
					...
					Assert.assertEquals(
							testData[i][0],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_double").getNewValue()))
									.doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_double").getOldValue());
					Assert.assertEquals(
							testData[i][1],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_double").getNewValue()))
									.doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_double").getOldValue());
					Assert.assertEquals(
							testData[i][2],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_double").getNewValue()))
									.doubleValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_double").getOldValue());
					Assert.assertEquals(
							testData[i][3],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_double").getNewValue()))
									.doubleValue());
			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testDataOld.length; i++) {
					...
					Assert.assertEquals(
							testDataOld[i][0],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_double").getOldValue()))
									.doubleValue());
					Assert.assertEquals(
							testDataNew[i][1],
							Double.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][1],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_double").getOldValue()))
									.doubleValue());
					Assert.assertEquals(
							testDataNew[i][2],
							Double.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][2],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_double").getOldValue()))
									.doubleValue());
					Assert.assertEquals(
							testDataNew[i][3],
							Double.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][3],
							Double.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_double").getOldValue()))
									.doubleValue());
				}
			}
