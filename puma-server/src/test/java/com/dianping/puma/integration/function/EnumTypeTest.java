 ...
 *
 */
public class EnumTypeTest extends AbstractBaseTest {
	
	private static final Logger LOG = LoggerFactory.getLogger(EnumTypeTest.class);
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for(int i = 0; i < testData.length; i++){
					...
					Assert.assertEquals(String.valueOf(i + 1), String.valueOf(rowChangedEvent.getColumns().get("default_enum").getNewValue()));
