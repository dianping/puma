			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testData.length; i++) {
					...
					Assert.assertEquals(
							testData[i][0],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_float").getNewValue()))
									.floatValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_float").getOldValue());
					Assert.assertEquals(
							testData[i][1],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_float").getNewValue()))
									.floatValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_float").getOldValue());
					Assert.assertEquals(
							testData[i][2],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_float").getNewValue()))
									.floatValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_float").getOldValue());
					Assert.assertEquals(
							testData[i][3],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_float").getNewValue()))
									.floatValue());
			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testDataOld.length; i++) {
					...
					Assert.assertEquals(
							testDataOld[i][0],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_float").getOldValue()))
									.floatValue());
					Assert.assertEquals(
							testDataNew[i][1],
							Float.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][1],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_float").getOldValue()))
									.floatValue());
					Assert.assertEquals(
							testDataNew[i][2],
							Float.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][2],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_float").getOldValue()))
									.floatValue());
					Assert.assertEquals(
							testDataNew[i][3],
							Float.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][3],
							Float.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_float").getOldValue()))
									.floatValue());
				}
			}
