			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testData.length; i++) {
					...
					Assert.assertEquals(
							testData[i][0],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_int").getNewValue()))
									.intValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_int").getOldValue());
					Assert.assertEquals(
							testData[i][1],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_int").getNewValue()))
									.intValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_int").getOldValue());
					Assert.assertEquals(
							testData[i][2],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_int").getNewValue()))
									.intValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_int").getOldValue());
					Assert.assertEquals(
							testData[i][3],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_int").getNewValue()))
									.intValue());
			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testDataOld.length; i++) {
					...
					Assert.assertEquals(
							testDataOld[i][0],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_int").getOldValue()))
									.intValue());
					Assert.assertEquals(
							testDataNew[i][1],
							Integer.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][1],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_int").getOldValue()))
									.intValue());
					Assert.assertEquals(
							testDataNew[i][2],
							Integer.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][2],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_int").getOldValue()))
									.intValue());
					Assert.assertEquals(
							testDataNew[i][3],
							Integer.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][3],
							Integer.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_int").getOldValue()))
									.intValue());
				}
			}
