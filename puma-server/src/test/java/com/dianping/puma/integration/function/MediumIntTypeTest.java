		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for(int i = 0; i < testData.length; i++){
					...
					Assert.assertEquals(testData[i][0], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_mediumInt").getNewValue())).intValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_mediumInt").getOldValue());
					Assert.assertEquals(testData[i][1], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_mediumInt").getNewValue())).intValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_mediumInt").getOldValue());
					Assert.assertEquals(testData[i][2], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_mediumInt").getNewValue())).intValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_mediumInt").getOldValue());
					Assert.assertEquals(testData[i][3], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_mediumInt").getNewValue())).intValue());
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for(int i = 0; i < testDataOld.length; i++){
					...
					Assert.assertEquals(SCHEMA_NAME, rowChangedEvent.getDatabase());
					Assert.assertEquals(5, rowChangedEvent.getColumns().size());
					Assert.assertEquals(testDataNew[i][0], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_mediumInt").getNewValue())).intValue());
					Assert.assertEquals(testDataOld[i][0], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unsigned_mediumInt").getOldValue())).intValue());
					Assert.assertEquals(testDataNew[i][1], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_mediumInt").getNewValue())).intValue());
					Assert.assertEquals(testDataOld[i][1], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("signed_mediumInt").getOldValue())).intValue());
					Assert.assertEquals(testDataNew[i][2], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_mediumInt").getNewValue())).intValue());
					Assert.assertEquals(testDataOld[i][2], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("zerofill_mediumInt").getOldValue())).intValue());
					Assert.assertEquals(testDataNew[i][3], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_mediumInt").getNewValue())).intValue());
					Assert.assertEquals(testDataOld[i][3], Integer.valueOf(String.valueOf(rowChangedEvent.getColumns().get("unzerofill_mediumInt").getOldValue())).intValue());
				}
			}
