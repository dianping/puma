 ...
 *
 */
public class Timestamp2TypeTest extends AbstractBaseTest {

	private static final Logger LOG = LoggerFactory.getLogger(Timestamp2TypeTest.class);
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testData.length; i++) {
					...
					queryRunner.update(insert_SQL, testData[i][0], testData[i][1], testData[i][2], testData[i][3], testData[i][4], testData[i][5], testData[i][6]);
				}
				...
				for (int i = 0; i < testData.length; i++) {
					...
					Assert.assertEquals(testData[i][0],String.valueOf(rowChangedEvent.getColumns().get("size_timestamp1").getNewValue()));
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("size_timestamp1").getOldValue());
					Assert.assertEquals(testData[i][1],String.valueOf(rowChangedEvent.getColumns().get("size_timestamp2").getNewValue()));
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("size_timestamp2").getOldValue());
					Assert.assertEquals(testData[i][2],String.valueOf(rowChangedEvent.getColumns().get("size_timestamp3").getNewValue()));
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("size_timestamp3").getOldValue());
					Assert.assertEquals(testData[i][3],String.valueOf(rowChangedEvent.getColumns().get("size_timestamp4").getNewValue()));
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("size_timestamp4").getOldValue());
					Assert.assertEquals(testData[i][4],String.valueOf(rowChangedEvent.getColumns().get("size_timestamp5").getNewValue()));
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("size_timestamp5").getOldValue());
					Assert.assertEquals(testData[i][5],String.valueOf(rowChangedEvent.getColumns().get("size_timestamp6").getNewValue()));
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("size_timestamp6").getOldValue());
					Assert.assertEquals(testData[i][6],String.valueOf(rowChangedEvent.getColumns().get("unsize_timestamp").getNewValue()));
