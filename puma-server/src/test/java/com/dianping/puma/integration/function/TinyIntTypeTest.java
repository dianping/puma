...
public class TinyIntTypeTest extends AbstractBaseTest {
			...
			public void doLogic() throws Exception {
				...
				for (int i = 0; i < testData.length; i++) {
					...
					Assert.assertEquals(
							testData[i][0],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_tinyInt").getNewValue()))
									.byteValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("unsigned_tinyInt").getOldValue());
					Assert.assertEquals(
							testData[i][1],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_tinyInt").getNewValue()))
									.byteValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("signed_tinyInt").getOldValue());
					Assert.assertEquals(
							testData[i][2],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_tinyInt").getNewValue()))
									.byteValue());
					Assert.assertEquals(null, rowChangedEvent.getColumns().get("zerofill_tinyInt").getOldValue());
					Assert.assertEquals(
							testData[i][3],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_tinyInt").getNewValue()))
									.byteValue());
		...
		test(new TestLogic() {
			...
			public void doLogic() throws Exception {
				byte[][] testDataOld = { { 11, 11, 1, 1 }, { 11, -11, 9, 9 }, { 33, 77, 10, 10 }, { 33, -77, 99, 99 },
						{ 126, 127, 100, 100 }, { 126, -127, 127, 127 } };
				byte[][] testDataNew = { { 11, -11, 1, 1 }, { 11, -11, 1, 1 }, { 33, -77, 10, 10 },
						{ 33, -77, 10, 10 }, { 126, -127, 100, 100 }, { 126, -127, 100, 100 } };
				...
				for (int i = 0; i < testDataOld.length; i++) {
					...
					Assert.assertEquals(
							testDataOld[i][0],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unsigned_tinyInt").getOldValue()))
									.byteValue());
					Assert.assertEquals(
							testDataNew[i][1],
							Byte.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][1],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("signed_tinyInt").getOldValue()))
									.byteValue());
					Assert.assertEquals(
							testDataNew[i][2],
							Byte.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][2],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("zerofill_tinyInt").getOldValue()))
									.byteValue());
					Assert.assertEquals(
							testDataNew[i][3],
							Byte.valueOf(
					...
					Assert.assertEquals(
							testDataOld[i][3],
							Byte.valueOf(
									String.valueOf(rowChangedEvent.getColumns().get("unzerofill_tinyInt").getOldValue()))
									.byteValue());
				}
			}
	...
	public void tinyIntTypeDeleteTest() throws Exception {
		test(new TestLogic() {
			...
			@Override
			public void doLogic() throws Exception {
				byte[][] testDataOld = { { 11, -11, 1, 1 }, { 11, -11, 1, 1 }, { 33, -77, 10, 10 },
						{ 33, -77, 10, 10 }, { 126, -127, 100, 100 }, { 126, -127, 100, 100 } };
