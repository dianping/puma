 ...
 */
package com.dianping.puma.common.datatype;
...
public final class Longs {
     ...
     * in java, which might be different from {@code ((Long) value).hashCode()}
     * in GWT because {@link Long#hashCode()} in GWT does not obey the JRE
     * contract.
     * 
     * @param value
     ...
     * 
     * @param array
     *            an array of {@code long} values, possibly empty
     * @param target
     *            a primitive {@code long} value
     ...
     * 
     * @throws IllegalArgumentException
     *             if {@code bytes} has fewer than 8 elements
     */
    public static long fromByteArray(byte[] bytes) {
        ...
        if (bytes.length < BYTES) {
            throw new IllegalArgumentException("array too small: " + bytes.length + " < " + BYTES);
        }
     ...
     * to a {@code long} value in the manner of {@link Number#longValue}.
     * 
     * <p>
