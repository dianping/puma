...
import com.dianping.puma.common.mysql.variable.status.QAutoIncrement;
import com.dianping.puma.common.mysql.variable.status.QCatalogCode;
import com.dianping.puma.common.mysql.variable.status.QCatalogNZCode;
import com.dianping.puma.common.mysql.variable.status.QCharsetCode;
import com.dianping.puma.common.mysql.variable.status.QCharsetDatabaseCode;
import com.dianping.puma.common.mysql.variable.status.QFlags2Code;
import com.dianping.puma.common.mysql.variable.status.QLCTimeNamesCode;
import com.dianping.puma.common.mysql.variable.status.QSQLModeCode;
import com.dianping.puma.common.mysql.variable.status.QTableMapForUpdateCode;
import com.dianping.puma.common.mysql.variable.status.QTimeZoneCode;
