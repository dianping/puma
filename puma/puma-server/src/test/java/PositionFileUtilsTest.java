...
//
//		PositionInfo a = new PositionInfo(1, "file.txt");
//
//		PositionFileUtils positionfileutil = new PositionFileUtils();
//
//		long num = 123;
//		positionfileutil.savePositionInfo(num, a);
//
//		Assert.assertEquals(
//				"PositionInfor [binlogFileName=file.txt, binlogPosition=1]",
//				positionfileutil.getPositionInfo(num).toString());
//	}
//
//	@Test
...
//		PositionFileUtils positionfileutil = new PositionFileUtils();
//		long num = 1;
//		PositionInfo pos = new PositionInfo(num, "3459038405+erti");
//		positionfileutil.saveToFile("E:/", num, pos);
//
