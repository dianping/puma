...
public final class IndexManagerFactory {
	...
	public static L2SingleWriteIndexManager newL2SingleWriteIndexManager(File file) {
		return new L2SingleWriteIndexManager(file, L2_WRITE_BUF_SIZE_BYTE, L2_WRITE_MAX_SIZE_BYTE);
	}

	public static L2SingleWriteIndexManager newL2SingleWriteIndexManager(File file, int bufSizeByte, int maxSizeByte) {
		return new L2SingleWriteIndexManager(file, bufSizeByte, maxSizeByte);
	}
}
