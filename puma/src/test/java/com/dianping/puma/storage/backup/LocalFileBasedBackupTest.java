...
/**
 * Dozer @ 7/16/15 mail@dozer.cc http://www.dozer.cc
 */
public class LocalFileBasedBackupTest {
	...
	public void deleteFolderTest() throws NoSuchMethodException, IOException, IllegalAccessException,
		...
		if (folder.mkdirs()) {
			...
			Method deleteFolder = LocalFileBasedBackup.class.getDeclaredMethod("deleteFolder", File.class,
			      DeleteStrategy.class);
