...
//
//public class GroupDataManagerFinderTest {
//
//	private File tempDir;
//
//	private GroupDataManagerFinder manager;
//
//	@Before
...
//
//		manager = new GroupDataManagerFinder(tempDir.getName(), "test");
//		manager.start();
...
//
//		ReadBucket expected_0 = new LocalFileReadBucket(
//				new Sequence(20150925, 0, 0),
//				new File(new File(manager.rootDir(), "20150925"), "Bucket-0"));
//		ReadBucket result_0 = manager.findReadDataBucket(new Sequence(20150925, 0, 100));
//		assertTrue(EqualsBuilder.reflectionEquals(expected_0, result_0));
//
//		ReadBucket expected_1 = new LocalFileReadBucket(
//				new Sequence(20150926, 1, 0),
//				new File(new File(manager.rootDir(), "20150926"), "Bucket-1"));
//		ReadBucket result_1 = manager.findReadDataBucket(new Sequence(20150926, 1, 0));
//		assertTrue(EqualsBuilder.reflectionEquals(expected_1, result_1));
//
//		ReadBucket expected_2 = new LocalFileReadBucket(
//				new Sequence(20150926, 1, 0),
//				new File(new File(manager.rootDir(), "20150926"), "Bucket-1"));
//		ReadBucket result_2 = manager.findReadDataBucket(new Sequence(20150926, 1, 20000));
//		assertTrue(EqualsBuilder.reflectionEquals(expected_2, result_2));
//
//		ReadBucket expected_3 = new LocalFileReadBucket(
//				new Sequence(20150925, 0, 0),
//				new File(new File(manager.rootDir(), "20150925"), "Bucket-0"));
//		ReadBucket result_3 = manager.findReadDataBucket(new Sequence(20150925, 0, 1000));
...
//		createNewFile(new File(file_0, "Bucket-2"));
//
//		ReadBucket result_0 = manager.findReadDataBucket(new Sequence(20150926, 3, 100));
//		assertNull(result_0);
//
//		ReadBucket result_1 = manager.findReadDataBucket(new Sequence(20150924, 3, 100));
//		assertNull(result_1);
//
//		ReadBucket result_2 = manager.findReadDataBucket(new Sequence(20150925, 5, 100));
//		assertNull(result_2);
//	}
//
//	@Test
...
//		ReadBucket result_0 = manager.findNextReadDataBucket(new Sequence(20150925, 0, 100));
//		assertTrue(EqualsBuilder.reflectionEquals(expected_0, result_0));
//
//		ReadBucket expected_1 = new LocalFileReadBucket(
//				new Sequence(20150926, 2, 0),
//				new File(new File(manager.rootDir(), "20150926"), "Bucket-2"));
//		ReadBucket result_1 = manager.findNextReadDataBucket(new Sequence(20150926, 1, 0));
//		assertTrue(EqualsBuilder.reflectionEquals(expected_1, result_1));
//
//		ReadBucket expected_2 = new LocalFileReadBucket(
//				new Sequence(20150926, 2, 0),
//				new File(new File(manager.rootDir(), "20150926"), "Bucket-2"));
//		ReadBucket result_2 = manager.findNextReadDataBucket(new Sequence(20150926, 1, 20000));
//		assertTrue(EqualsBuilder.reflectionEquals(expected_2, result_2));
//
//		ReadBucket expected_3 = new LocalFileReadBucket(
//				new Sequence(20150925, 1, 0),
//				new File(new File(manager.rootDir(), "20150925"), "Bucket-1"));
//		ReadBucket result_3 = manager.findNextReadDataBucket(new Sequence(20150925, 0, 1000));
//		assertTrue(EqualsBuilder.reflectionEquals(expected_3, result_3));
//	}
//
//	@Test
