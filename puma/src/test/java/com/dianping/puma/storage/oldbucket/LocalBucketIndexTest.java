...
public class LocalBucketIndexTest {
    ...
    protected LocalFileDataBucketManager localBucketIndex = new LocalFileDataBucketManager();
    ...
    public void before() {
        ...
        localBucketIndex.setBaseDir(new File(System.getProperty("java.io.tmpdir", "."), "Puma").getAbsolutePath());
    ...
    public void testCopyFromLocal() throws Exception {
        ...
        this.localBucketIndex.start();
        try {
            this.localBucketIndex.copyFromLocal(new File(System.getProperty("java.io.tmpdir", "."), "/Puma/copy").getAbsolutePath(),
                    "20120713/bucket-0");
        } catch (StorageClosedException e) {
            e.printStackTrace();
        } catch (IOException e) {
